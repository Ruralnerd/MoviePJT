    ...
    <div class="bg1 p-5">
      <b-form class="">
        ...
        <b-form-group id="input-group-1" label="아이디" label-for="username" class="text-start">
          <b-form-input id="username" v-model="credentials.username" type="text" placeholder="아이디를 입력해 주세요." class="form-control"></b-form-input>
        </b-form-group>
        <br>
        <!-- 비밀번호 -->
        ...
        <br>
        <!-- 로그인 버튼 -->
        <button type="button" class="btn bg-light" @click="signin">로그-인</button>
      </b-form> 
    </div>
  </div>
</template>
